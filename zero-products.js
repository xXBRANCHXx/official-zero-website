...
export const ZERO_PRODUCTS = {
    syrup: {
        ...
        options: [
            ...
            { id: 'pumpkin-spice', name: 'Pumpkin Spice', group: 'Coffee Flavors', image: '/ZERO Media/ZERO Syrup Renders/Pumpkin Spice.png?v=plain-20260603', description: 'Seasonal spice profile.', sizes: ['50ml', '250ml', '550ml'] },
            ...
            { id: 'lemonade', name: 'Lemonade', group: 'Other Flavors', image: '/ZERO Media/ZERO Syrup Renders/Lemonade.png?v=plain-20260603', description: 'Citrus-forward lemonade sweetness.', sizes: ['50ml', '250ml', '550ml'] },
