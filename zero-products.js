...
export const ZERO_PRODUCTS = {
    ...
    drops: {
        ...
        heroImage: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png',
        description: 'Pocket-sized concentrated sweetness. Just 5 to 7 drops can sweeten a drink.',
        options: [
            { id: 'plain', name: 'Plain', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'The core all-purpose drops flavor.', sizes: ['5ml', '10ml', '30ml'] },
            { id: 'hazelnut', name: 'Hazelnut', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Nutty cafe profile for coffee drinks.', sizes: ['5ml', '30ml'] },
            { id: 'pumpkin-spice', name: 'Pumpkin Spice', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Warm spice notes for seasonal drinks.', sizes: ['5ml', '30ml'] },
            { id: 'caramel', name: 'Caramel', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Classic caramel sweetness.', sizes: ['5ml', '30ml'] },
            { id: 'butterscotch', name: 'Butterscotch', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Rich buttery sweetness in concentrated form.', sizes: ['5ml', '30ml'] },
            { id: 'pandan', name: 'Pandan', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Fragrant pandan profile for creative drinks.', sizes: ['5ml', '30ml'] },
            { id: 'pistachio', name: 'Pistachio', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Nutty drops for coffee and dessert drinks.', sizes: ['5ml', '30ml'] },
            { id: 'vanilla', name: 'Vanilla', group: 'Coffee Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Smooth vanilla sweetness.', sizes: ['5ml', '30ml'] },
            { id: 'strawberry-kiwi', name: 'Strawberry Kiwi', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Fruit-forward blend built for cold drinks.', sizes: ['30ml'] },
            { id: 'lychee-bloom', name: 'Lychee Bloom', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Floral lychee profile with a brighter finish.', sizes: ['30ml'] },
            { id: 'grapefruit', name: 'Grapefruit', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Crisp citrus bitterness balanced by sweetness.', sizes: ['30ml'] },
            { id: 'peach-mango', name: 'Peach Mango', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Soft peach layered with tropical mango.', sizes: ['30ml'] },
            { id: 'lemonade', name: 'Lemonade', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Bright lemonade flavor for water and sodas.', sizes: ['30ml'] },
            { id: 'cucumber-mint', name: 'Cucumber Mint', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Cooling fresh profile for light drinks.', sizes: ['30ml'] },
            { id: 'blue-raspberry', name: 'Blue Raspberry', group: 'Other Flavors', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (43).png', description: 'Candy-like berry flavor for bold mixed drinks.', sizes: ['30ml'] },
        ],
        sizes: [
    ...
    mapleTopping: {
        ...
        heroImage: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (45).png',
        description: 'A thick zero-calorie topping with real maple extract made for pancakes, yogurt, and heavier pours.',
        options: [
            { id: 'classic-maple', name: 'Classic Maple', group: 'Topping', image: '/ZERO Media/New Drops, Topping Images/New Syrups Zero Product 11 (45).png', description: 'Thick maple topping for food applications. This is not the same as ZERO Maple Syrup for coffee.', sizes: ['550ml'] },
        ],
        sizes: [
