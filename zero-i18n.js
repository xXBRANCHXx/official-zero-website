...
const ID_TRANSLATIONS = {
    ...
    'Built for Better Daily Habits.': 'Dibuat untuk Kebiasaan Harian yang Lebih Baik.',
    ...
    'Choose the dropper that fits your routine.': 'Pilih ukuran drops yang sesuai dengan rutinitas Anda.',
    'Choose the fiber syrup that fits your drink.': 'Pilih fiber syrup yang cocok untuk minuman Anda.',
    'Choose Your ZERO.': 'Pilih ZERO Anda.',
    ...
    'Easy to order and repeat': 'Mudah dipesan dan dibeli ulang',
    ...
    'Find ZERO in Yogyakarta.': 'Temukan ZERO di Yogyakarta.',
    'Flavor options': 'Pilihan rasa',
    'Flavor paths': 'Pilihan profil rasa',
    'Follow': 'Ikuti',
    ...
    'For daily drinks.': 'Untuk minuman harian.',
    'For sweetness anywhere.': 'Untuk rasa manis di mana saja.',
    'For thicker pours.': 'Untuk tuangan yang lebih kental.',
    ...
    'Function, Without Making The Routine Harder.': 'Fungsi Lebih Baik, Tanpa Membuat Rutinitas Lebih Sulit.',
    'Functional support': 'Dukungan fungsional',
    ...
    'Healthy choices made easy.': 'Pilihan sehat jadi mudah.',
    'Healthy choices,': 'Pilihan sehat,',
    'Healthy choices, made easier.': 'Pilihan sehat jadi lebih mudah.',
    'Healthy sweetness made easy.': 'Manis sehat jadi mudah.',
    ...
    'Indonesia\'s #1 Best-Selling Zero-Calorie Syrup.': 'Sirup Nol Kalori Terlaris #1 di Indonesia.',
    ...
    'Legal Info / intentionally boring / updated 2026': 'Info Legal / sengaja dibuat serius / diperbarui 2026',
    'Lineup': 'Rangkaian',
    'Loading ZERO website': 'Memuat situs ZERO',
    'Made For Food, Not Coffee.': 'Dibuat untuk Makanan, Bukan Kopi.',
    ...
    'Maple Topping comes in a single 550ml food format, built for thicker pours where a drink syrup would feel too light.': 'Maple Topping hadir dalam satu format makanan 550 ml, dibuat untuk tuangan lebih kental saat sirup minuman terasa terlalu ringan.',
    ...
    'Not medical advice. Just useful food experiments.': 'Bukan saran medis. Hanya eksperimen makanan yang berguna.',
    ...
    'One bottle. One clear use case.': 'Satu botol. Satu fungsi yang jelas.',
    'One Brand, Three Daily Jobs.': 'Satu Brand, Tiga Fungsi Harian.',
    ...
    'One Lineup, Three Clear Jobs.': 'Satu Rangkaian, Tiga Fungsi Jelas.',
    ...
    'Pick the ACVS bottle for the routine.': 'Pilih botol ACVS sesuai rutinitas.',
    'Pick the flavor. Match the bottle.': 'Pilih rasa. Sesuaikan ukuran botol.',
    'Plain': 'Original',
    ...
    'Real food. Real glucose curves.': 'Makanan nyata. Kurva glukosa nyata.',
    ...
    'Regulatory references, not hype.': 'Referensi regulasi, bukan hype.',
    'Results': 'Hasil',
    ...
    'See what spikes your blood sugar.': 'Lihat makanan yang memicu lonjakan gula darah.',
    'Shop': 'Belanja',
    ...
    'Strawberry': 'Stroberi',
    'Sucralose': 'Sukralosa',
    'Sugar, minus the part you did not want.': 'Manis gula, tanpa bagian yang tidak Anda inginkan.',
    'sugar.': 'gula.',
    ...
    'The daily drink bottle.': 'Botol untuk minuman harian.',
    'The fine print.': 'Catatan penting.',
    ...
    'The heavier pour.': 'Tuangan yang lebih kental.',
    ...
    'The people behind ZERO.': 'Orang-orang di balik ZERO.',
    ...
    'Three Formats. One Shared Goal.': 'Tiga Format. Satu Tujuan.',
    'Topping': 'Topping',
    ...
    'Wellness That Fits Daily Life.': 'Wellness yang Cocok untuk Rutinitas Harian.',
    'What Customers Keep Saying.': 'Yang Terus Dikatakan Pelanggan.',
    'What we make': 'Yang kami buat',
    'WhatsApp: +62 858-4283-3973': 'WhatsApp: +62 858-4283-3973',
    'Why choose it': 'Mengapa memilih ini',
    'Why sucralose, not stevia or aspartame?': 'Mengapa sukralosa, bukan stevia atau aspartam?',
    ...
    'ZERO Drops Go Anywhere.': 'ZERO Drops Bisa Dibawa ke Mana Saja.',
    ...
    'ZERO MAPLE TOPPING for Food.': 'ZERO MAPLE TOPPING untuk Makanan.',
    ...
    'ZERO Syrup for Daily Drinks.': 'ZERO Syrup untuk Minuman Harian.',
...
const createLanguageToggle = () => {
    ...
    item.className = 'language-switch-slot';
    ...
    const toggle = item.querySelector('#zero-language-toggle');
