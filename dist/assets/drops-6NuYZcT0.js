import"./modulepreload-polyfill-B5Qt9EMX.js";import{l as f,a as D,Z as R,i as Z}from"./index-CsdmHk0P.js";const s=[{src:"/ZERO Media/ZERO Drops Images/Carousel/ZERO Drops Carousel 1.jpg",alt:"ZERO Drops product image"},{src:"/ZERO Media/ZERO Drops Images/Carousel/ZERO Drops Carousel 2.jpg",alt:"ZERO Drops flavor drops image"},{src:"/ZERO Media/ZERO Drops Images/Carousel/ZERO Drops Carousel 3.jpg",alt:"ZERO Drops compact product page image"}],b=e=>{var l;const a=(l=s[0])==null?void 0:l.src;return a?{...e,heroImage:a,options:e.options.map(r=>({...r,image:a}))}:e},S=()=>{var y,w;const e=document.querySelector(".syrup-visual-shell"),a=document.getElementById("selected-drops-image");if(!e||!a||s.length<2)return;let l=0,r=1,o=1,i=0,n=null,p=null;const c=[s[s.length-1],...s,s[0]],u=()=>{e.style.setProperty("--syrup-carousel-position",r)},g=()=>{e.querySelectorAll(".syrup-carousel-slide").forEach((t,d)=>{const C=Number(t.dataset.realIndex),O=d===Math.round(r)&&C===l;t.setAttribute("aria-hidden",O?"false":"true")})},E=()=>{o===c.length-1?(r=1,o=1):o===0&&(r=s.length,o=s.length),i=0,u(),g()},m=()=>{const t=o-r;if(i+=t*.2,i*=.72,r+=i,u(),Math.abs(t)<.003&&Math.abs(i)<.003){r=o,n=null,E();return}n=window.requestAnimationFrame(m)},h=t=>{o===c.length-1?(r=1,o=1):o===0&&(r=s.length,o=s.length),l=(l+t+s.length)%s.length,o+=t,i+=t*.12,g(),n||(n=window.requestAnimationFrame(m))},I=()=>{window.clearInterval(p),p=window.setInterval(()=>{h(1)},3200)},v=t=>{h(t),I()};e.classList.add("syrup-carousel-shell"),a.classList.add("syrup-carousel-source-image"),a.setAttribute("aria-hidden","true"),e.insertAdjacentHTML("beforeend",`
